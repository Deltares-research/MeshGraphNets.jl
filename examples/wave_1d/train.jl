...
ns = 30*361 # Total number of steps seen during training, overrides epochs if epochs is set too low
nbatch = 1
...
mgn, losses_dict = train_network(
    ...
    noise_stddevs = noise_stddevs, solver_valid = Euler(), solver_valid_dt = 60.0,
